...
# UWYK's `src/` for SCM prior + BinarizingMechanism. Override via env if
# your local clone is elsewhere; also see training/README.md.
REPO_SRC  = os.environ.get('UWYK_SRC', '/tmp/g4cfm_uwyk/src')
# We live in R-PFN/training/ — parent dir is the R-PFN root.
